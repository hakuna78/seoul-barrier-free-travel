...
PAGE_SIZE = 100
OUTPUT_DIR = "data"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "seoul_barrierfree_restaurants.json")
...
def fetch_all_spots():
    ...
    print(f"서울 무장애 음식점 총 {total}건 수집 시작...")
...
def main():
    ...
    # 2. 각 음식점별 상세정보 수집 (전부 음식점이므로 카테고리 필터 불필요)
    documents = []
    total = len(spots)
